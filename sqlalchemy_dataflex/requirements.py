"""Testing requirements for SQLAlchemy-Dataflex."""
# coding=utf-8
...
class Requirements(SuiteRequirements):
    """SQLAlchemy test suite requirements for Dataflex."""
    ...
    def on_update_or_deferrable_fks(self):
        """On update or deferrable foreign keys."""
        return exclusions.closed()
    ...
    def fetch_rows_post_commit(self):
        ...
        is invoked within "autocommit". If the row can be returned after
        the autocommit, then this rule can be open.
        """
    ...
    def sane_multi_rowcount(self):
        """Sane multi-row count."""
        return exclusions.closed()

    @property
    def sane_rowcount_w_returning(self):
        """Sane row count when returning."""
        return exclusions.closed()
    ...
    def threading_with_mock(self):
        ...
        """
        return exclusions.skip_if(
            lambda config: util.py3k and config.options.has_coverage, "Stability issues with coverage + py3k",
        )

    @property
    def python2(self):
        """Python 2."""
        return exclusions.skip_if(lambda: sys.version_info >= (3,), "Python version 2.xx is required.",)
    ...
    def python36(self):
        """Python 3.6."""
        return exclusions.skip_if(lambda: sys.version_info < (3, 6), "Python version 3.6 or greater is required.",)

    @property
    def python37(self):
        """Python 3.7."""
        return exclusions.skip_if(lambda: sys.version_info < (3, 7), "Python version 3.7 or greater is required.",)
    ...
    def non_broken_pickle(self):
        ...
        return exclusions.only_if(
            lambda: not util.pypy and pickle.__name__ == "cPickle" or sys.version_info >= (3, 2),
    ...
    def no_coverage(self):
        ...
        """
        return exclusions.skip_if(
            lambda config: config.options.has_coverage, "Issues observed when coverage is enabled",
        )
    ...
    def cextensions(self):
        """C extensions."""
        return exclusions.skip_if(lambda: not self._has_cextensions(), "C extensions not installed")
